...
import { FaParking, FaShare,FaChair } from "react-icons/fa";
...
const Listing = () => {
  ...
  return (
    <main>
      ...
      {
        shareLinkCopied && (<p className="fixed top-[23%] text-lg right-[5%] font-semibold border-2 border-gray-400 rounded-md bg-white z-10 p-[10px]">Link Copied</p>)
      }

      <div className="m-4 p-4 rounded-lg shadow-lg bg-white flex flex-col md:flex-row max-w-6xl lg:mx-auto lg:space-x-5">
        ...
        {listing.offer && (<p className="w-full max-w-[200px] bg-green-800 rounded-md p-1 text-white text-center font-semibold shadow-md">₹{listing.regularPrice - listing.discountedPrice} Discount</p>)}
        </div>
