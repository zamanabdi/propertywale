    ...
    >
      <header className="flex  md:h-[56px] flex-row w-[1550px] justify-between items-center px-3">
        ...
        >
          ...
          <span className="flex justify-center items-center text-orange-400 text-[12px] sm:text-[15px] md:text-[2rem] font-bold shrink-0" style={{fontFamily:'Abril Fatface'}}>
            Property
          </span>
          <span className="flex items-center justify-center text-gray-500 text-[12px] sm:text-[15px] md:text-[2rem] font-bold shrink-0" style={{fontFamily:'Abril Fatface'}}>
            Wale
          </span>
        </div>
        <div className="flex flex-row md:w-[500px] h-full items-center justify-center">
          <ul className="flex bg-white md:flex-row justify-evenly items-center space-x-3 md:gap-10 text-[14px] md:text-[1.5rem] font-semibold text-gray-500 ml-5">
